    ...
    <div className="tela">
      ...
      <div className="login-wrap anim-pop">
        <form className="login-card" onSubmit={handle}>
          ...
          <input id="nova" type="password" placeholder="Mínimo 8 caracteres" maxLength={128} value={novaSenha} onChange={e=>setNovaSenha(e.target.value)} required />
          ...
          <input id="conf" type="password" placeholder="Repita a senha" maxLength={128} value={confirm} onChange={e=>setConfirm(e.target.value)} required />
