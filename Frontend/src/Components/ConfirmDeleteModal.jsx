...
export default function ConfirmDeleteModal({ onClose, onConfirm, authorName }) {
  return (
    <div className="modal-overlay">
      <div className="modal-content-author modal-content-author--delete">
        <div className="modal-header-author">
          <h2>Excluir Autor</h2>
          <button className="close-button" onClick={onClose}>&times;</button>
        </div>
        <div className="modal-subtitle">Confirmação</div>
        <p className="confirm-delete-text" style={{ margin: 'var(--space-4) 0', color: 'var(--color-text-secondary)', fontSize: 'var(--text-sm)' }}>
